sap.ui.define([
		...
		return BaseObject.extend("hello.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias hello.model.ListSelector
			 */
			 ...
			 * @return {hello.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
